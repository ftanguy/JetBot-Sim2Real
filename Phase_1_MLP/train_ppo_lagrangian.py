...
class ActorCritic(nn.Module):
    ...
    def __call__(self, x, forced_log_std: float = None):
        ...
        pi = dist.Normal(actor_mean, jnp.exp(actor_logtstd)).to_event(1)
...
if __name__ == "__main__":
    ...
    env_hyperparams_to_save = {
        ...
        "deadzone_d_plus_min": env_params.deadzone_d_plus_min,
        "deadzone_d_plus_max": env_params.deadzone_d_plus_max,
        "deadzone_d_minus_min": env_params.deadzone_d_minus_min,
        "deadzone_d_minus_max": env_params.deadzone_d_minus_max,
        "deadzone_alpha_max": env_params.deadzone_alpha_max,
        "deadzone_alpha_min": env_params.deadzone_alpha_min,
    }
